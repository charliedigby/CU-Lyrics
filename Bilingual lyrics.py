...
"""
With the monoglot version now operational, this copy has been made in order to attempt the making
of a bilingual version, capable of handling lyrics across 2 languages. Since there are likely to
always be some songs which remain monoglot, this should be able to handle single language lyrics
as the former program, and ideally be able to update songs as welsh lyrics become available,
however, initially, this will likely necessitate the program always being run on the raw template,
and simply adding files to the supporting file bank.
"""
# %%
"""
**********************************************************************
